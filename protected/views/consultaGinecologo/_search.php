<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'presionSanguinea'); ?>
		<div class="input">
	...
	<div class="clearfix">
		<?php echo $form->label($model,'frecuenciaRespiratoria'); ?>
		<div class="input">
	...
	<div class="clearfix">
		<?php echo $form->label($model,'pulso'); ?>
		<div class="input">
	...
	<div class="clearfix">
		<?php echo $form->label($model,'fechaUltimaMenstruacion_f'); ?>
		<div class="input">
			
			<?php
					if ($model->fechaUltimaMenstruacion_f!='') 
						$fechaUltimaMenstruacion_f=date('d-m-Y',strtotime($fechaUltimaMenstruacion_f));
					else
						$fechaUltimaMenstruacion_f=date('d-m-Y');
					$this->widget('zii.widgets.jui.CJuiDatePicker', array(
					                                       'model'=>$model,
					                                       'attribute'=>'fechaUltimaMenstruacion_f',
					                                       'value'=>$fechaUltimaMenstruacion_f,
					                                       'language' => 'es',
					                                       'htmlOptions' => array('readonly'=>"readonly"),
					                                       'options'=>array(
					                                               'autoSize'=>true,
					                                               'defaultDate'=>$fechaUltimaMenstruacion_f,
					                                               'dateFormat'=>'yy-mm-dd',
					                                               'buttonImage'=>Yii::app()->baseUrl.'/images/calendar.png',
					                                               'buttonImageOnly'=>true,
					                                               'buttonText'=>'Fecha',
