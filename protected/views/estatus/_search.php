<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<div class="clearfix">
		<?php echo $form->label($model,'requisicion'); ?>
		<div class="input">
			
			<?php echo $form->textField($model,'requisicion',array('size'=>60,'maxlength'=>100)); ?>
		</div>
	</div>
	...
	<div class="clearfix">
		...
		<div class="input">
			...
			<?php echo $form->textField($model,'cotizacion',array('size'=>60,'maxlength'=>100)); ?>
		</div>
	</div>
