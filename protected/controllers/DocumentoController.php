...
class DocumentoController extends Controller
{
	...
	{
		$model = $this->loadModel($id);
		$arch = dirname(Yii::app()->request->scriptFile) . DIRECTORY_SEPARATOR . 'images/uploads/tmp' . DIRECTORY_SEPARATOR . $model->ruta;
		$proyectoID = $model->proyecto_did;
		unlink($arch);
		$model->delete();
		$this->redirect(array('proyecto/view','id'=> $proyectoID));
	}
