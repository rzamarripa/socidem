		...
		if(isset($_GET["estatus"])){
			...
			if($model->save()){
				if($model->estatus_did == 1)
					Yii::app()->user->setFlash("info","Se publicó la categoría: " . $model->nombre . ".");
				else
					Yii::app()->user->setFlash("warning","Se dejó de publicar la categoría: " . $model->nombre . ".");
				Yii::app()->db->createCommand("insert into Actividad (mensaje, usuario) Values ('Cambió de Estatus de la categora " . $model->nombre . " a " . $model->estatus->nombre . "', '" . Yii::app()->user->name . "')")->execute();
